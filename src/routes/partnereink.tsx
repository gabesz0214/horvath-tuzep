  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-between">
      ...
      <main className="flex-grow pt-28 pb-20 relative overflow-hidden bg-white">
        <div className="absolute inset-0 w-full h-full opacity-30 pointer-events-none z-0 bg-[linear-gradient(115deg,transparent_42%,#fee2e2_42%,#fee2e2_45%,transparent_45%,transparent_48%,#fee2e2_48%,#fee2e2_54%,transparent_54%)]" />
